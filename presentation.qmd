...
::: footer
Workshop Slack Channel: <https://bit.ly/tips2022ml>
:::
:::
...
- We want to capture as much signal and as little noise as possible
  ...
  - We do this by finding the optimal model parameter values
:::
...
- Our primary tool for these goals is **data splitting**
  ...
  - Instead of training our model on all of our data...
