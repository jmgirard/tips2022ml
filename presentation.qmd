...
- **Walkthrough #2 (Regression)**
  ...
  [Cali House]() $(n=2000, \text{Min}=\$15\text{k}, \text{Max}=\$500\text{k})$
...
ML researchers **develop algorithms** with the capacity to [learn from data]{.blue}
...
::: {.fragment}
- **Model Tuning**
  - Resampling, Optimization, Selection
:::
...
::: {.fragment}
- **Model Use**
  - Explanation, (Deployment), (Updating)
:::
...
## Data Splitting and Preprocessing {.smaller}
...
## Development and Tuning {.smaller}
...
## Explanation and Deployment {.smaller}
...
::: {.mt2}
4. Rerun the model from Walkthrough #2 using the [full Cali House dataset]() $(n=19675)$ rather than the downsampled version
:::
