...
### California Housing (Downsampled)
...
<a href="https://jmgirard.github.io/tips2022ml/data/calhouse_2000.csv"><button type="button" class="btn btn-primary">Download CSV</button></a>

```{r}
#| echo: false
#| message: false
read_csv("./data/calihouse_2000.csv")
```
...
### California Housing (Full)

Real data on 19,675 blocks in California from 1990 about houses, population, and location. Can be used to predict median house value (`house_mdn_value`, regression).

<a href="https://jmgirard.github.io/tips2022ml/data/calihouse.csv"><button type="button" class="btn btn-primary">Download CSV</button></a>

```{r}
#| echo: false
#| message: false
read_csv("./data/calihouse.csv")
```
